    ...
    public partial class VehicleController : Vehicle
    {
        ...
        public void UpdateInertiaTensor(float xCoeff = 1f, float yCoeff = 1f, float zCoeff = 1f)
        {
            ...
            Vector3 bodyInertia = new Vector3(
                (vehicleDimensions.y * vehicleDimensions.y + vehicleDimensions.z * vehicleDimensions.z) * 0.032f * mass * xCoeff,
                (vehicleDimensions.z * vehicleDimensions.z + vehicleDimensions.x * vehicleDimensions.x) * 0.065f * mass * yCoeff,
                (vehicleDimensions.x * vehicleDimensions.x + vehicleDimensions.y * vehicleDimensions.x) * 0.020f * mass * zCoeff
            );
        ...
        public virtual void SetDefaults()
        {
            ...
            if (physicsMaterial == null)
            {
                physicsMaterial = Resources.Load(defaultResourcesPath + "VehicleMaterial") as PhysicsMaterial;
            }
        ...
        public virtual void ApplyInitialRigidbodyValues()
        {
            ...
            vehicleRigidbody.linearDamping                   = drag;
            vehicleRigidbody.mass                   = mass;
            vehicleRigidbody.angularDamping            = angularDrag;
            vehicleRigidbody.centerOfMass           = centerOfMass;
            vehicleRigidbody.inertiaTensor          = inertiaTensor;
        ...
        private void ApplyLowSpeedFixes()
        {
            ...
            if (freezeWhileIdle)
            {
                ...
                float d = absVertInput * 2f + vehicleRigidbody.linearVelocity.magnitude * 4f + vehicleRigidbody.angularVelocity.magnitude * 4f;

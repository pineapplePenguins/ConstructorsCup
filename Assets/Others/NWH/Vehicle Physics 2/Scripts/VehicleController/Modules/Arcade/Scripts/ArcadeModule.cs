...
namespace NWH.VehiclePhysics2.Modules.ArcadeModule
{
    ...
    public partial class ArcadeModule : VehicleModule
    {
        ...
        public override void FixedUpdate()
        {
            ...
            // Steer assist
            _steerAngleDiff = VehicleController.CalculateSignedCentralAngle(vc.vehicleRigidbody.linearVelocity.normalized, vc.vehicleTransform.forward,
            ...
            Vector3 normVel = vc.vehicleRigidbody.linearVelocity.normalized;

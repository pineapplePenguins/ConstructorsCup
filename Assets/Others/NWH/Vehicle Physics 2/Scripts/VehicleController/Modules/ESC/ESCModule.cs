...
namespace NWH.VehiclePhysics2.Modules.ESC
{
    ...
    public partial class ESCModule : VehicleModule
    {
        ...
        public override void Update()
        {
            ...
            float angle = VehicleController.CalculateSignedCentralAngle(vc.vehicleRigidbody.linearVelocity, vc.vehicleTransform.forward,
            ...
            foreach (WheelComponent wheel in vc.Wheels)
            {
                ...
                wheel.AddBrakeTorque(additionalBrakeTorque);
            }
        }
